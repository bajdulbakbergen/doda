...
//
// Bump CACHE_NAME при структурных изменениях стратегии.

const CACHE_NAME = "doda-v1";
const OFFLINE_URL = "/offline";
const PRECACHE = [OFFLINE_URL, "/manifest.webmanifest", "/icon.svg", "/apple-touch-icon.svg"];
...
self.addEventListener("fetch", (event) => {
  ...
  // Skip Next.js RSC prefetches, Supabase realtime, API/auth routes
  if (
